...
const ORC_VS_HUMAN_BM: BuildOrder = {
  ...
  steps: [
    ...
    { time: "2:30", type: "building", action: "Voodoo Lounge → train Shaman",                priority: "critical" },
...
const ORC_VS_HUMAN_FS: BuildOrder = {
  ...
  steps: [
    { time: "0:00", type: "worker",   action: "Queue 3 Peons",                                note: "Send to gold immediately",             priority: "critical" },
    { time: "0:15", type: "worker",   action: "Send 4 Peons to gold, 1 to lumber",             priority: "critical" },
    { time: "0:30", type: "building", action: "Altar of Storms",                               note: "Hero building first — priority",        priority: "critical" },
    ...
    { time: "3:30", type: "building", action: "Voodoo Lounge → train Shaman",                  priority: "normal" },
